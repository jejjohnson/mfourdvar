...
class VariationalCost(eqx.Module):
    ...
    prior_weight: jax.Array = eqx.static_field()
    obs_op_weight: jax.Array = eqx.static_field()
    background_weight: jax.Array = eqx.static_field()
    ...
    def loss(
        ...
        # prior loss
        prior_loss = self.prior.loss(x, ts, x_gt, params=params)
